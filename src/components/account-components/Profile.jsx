  ...
  return (
    <div className={`${display ? "block" : "hidden"}`}>
      <div className="mb-8 h-fit w-full rounded-3xl bg-wb-lightgray p-8">
        <h1 className="text-3xl font-bold text-wb-gray">Profil</h1>
        ...
        <div className="min-h-80 flex w-full flex-wrap items-center justify-center gap-10 rounded-2xl bg-wb-white p-8 shadow-xl lg:justify-start lg:p-16">
          <div className="h-40 w-40 rounded-full bg-wb-red lg:h-60 lg:w-60"></div>
          <div className="text-center lg:text-left">
            <h1 className="text-3xl font-bold text-wb-gray">
              {userType === "restoran" ? "Restoran" : "Yayasan"}
            </h1>
            <h1 className="text-xl font-normal text-wb-gray">
              {userType === "restoran" ? "@restoran" : "@yayasan"}
            </h1>
          </div>
        </div>
