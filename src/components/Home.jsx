...
const Home = () => {
  return (
    <div className="">
      <div className="mx-8 mb-20 mt-10 flex items-center justify-between gap-20 md:mx-16">
        <div>
          ...
          <p className="mt-4 max-w-md text-base text-wb-gray">
            Tugas kami adalah menjembatani usaha donasi makanan anda kepada yang
            membutuhkan.
          </p>
      ...
      <div className="bg-deskripsi h-wb-30 bg-cover bg-center">
