...
const SupportCenter = () => {
  ...
  const SupportCenter = {
    ...
    5: {
      question: "Apa langkah-langkah dalam SOP Keamanan Makanan di Jembatan Aroma?",
      answer:
    ...
    6: {
      question: "Apakah ada biaya yang harus dibayar untuk menggunakan Jembatan Aroma?",
      answer:
    ...
    7: {
      question: "Bagaimana cara restoran atau yayasan bergabung dengan Jembatan Aroma?",
      answer:
    ...
    8: {
      question: "Apa saja keuntungan bagi restoran yang berpartisipasi dalam Jembatan Aroma?",
      answer:
